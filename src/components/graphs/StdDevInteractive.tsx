  ...
  return (
    ...
    >
      <h3 style={{ ...graphTitleStyle, marginBottom: 8 }}>
        כמה מהנתונים נמצאים במרחק של סטיית תקן אחת מהממוצע?
      </h3>
      <p style={{ ...graphSubtitleStyle, marginBottom: 16 }}>
        סטיית התקן (σ) מודדת עד כמה הנתונים מפוזרים סביב הממוצע. גררו נקודות כדי לפזר אותן, הזיזו את k (מספר סטיות התקן), וראו כמה נקודות נכנסות לטווח המסומן ±kσ.
      </p>
