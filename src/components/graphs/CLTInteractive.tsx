  ...
  return (
    ...
    >
      <h3 style={{ ...graphTitleStyle }}>
        למה ממוצעים של מדגמים תמיד יוצאים בצורת פעמון?
      </h3>
      <p style={{ ...graphSubtitleStyle }}>
        בחרו צורת התפלגות אב (גם עקומה או דו-שיאית), קבעו גודל מדגם n ולחצו "דגום". ההיסטוגרמה התחתונה אוספת את ממוצעי המדגמים — שימו לב איך היא מתיישרת לעקומת פעמון ככל שדוגמים יותר, לא משנה איך נראית התפלגות האם.
      </p>
