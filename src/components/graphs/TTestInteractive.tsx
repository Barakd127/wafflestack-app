  ...
  return (
    <div dir="rtl" style={{ background: 'rgba(255,255,255,0.92)', borderRadius: 16, padding: 20, margin: '24px auto', maxWidth: 700, color: '#1F3E6C' }}>
      ...
      <svg viewBox={`0 0 ${W} ${H}`} width="100%" height={H}>
        ...
        {[-4, -2, 0, 2, 4].map(t => (
          <g key={t}><line x1={toPx(t)} y1={Y1} x2={toPx(t)} y2={Y1 + 4} stroke="rgba(31,62,108,0.4)" />
            <text x={toPx(t)} y={Y1 + 18} fill="rgba(31,62,108,0.6)" fontSize={11} textAnchor="middle">{t}</text></g>
        ))}
