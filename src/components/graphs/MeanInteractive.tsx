  ...
  return (
    ...
    >
      <h3 style={graphTitleStyle}>
        היכן נמצאת נקודת האיזון של הנתונים? (הממוצע)
      </h3>
      <p style={graphSubtitleStyle}>
        כל עיגול הוא ערך על ציר המספרים, והמשולש הזהוב מסמן את הממוצע. גררו נקודה רחוק והתבוננו איך הממוצע נמשך לכיוונה — כמו משקולת שמטה את המאזניים. הוסיפו או הסירו נקודות כדי לראות את ההשפעה.
      </p>
