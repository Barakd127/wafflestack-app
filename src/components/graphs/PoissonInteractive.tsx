...
export default function PoissonInteractive() {
  ...
  return (
    <div dir="rtl" style={{ ...graphCardStyle }}>
      <h3 style={graphTitleStyle}>כמה סביר שיקרו k אירועים נדירים בפרק זמן קבוע?</h3>
      <p style={graphSubtitleStyle}>
        כל עמודה מראה את ההסתברות למספר אירועים מסוים (למשל כמה שיחות מגיעות למוקד בשעה). הזיזו את λ (מספר האירועים הממוצע) ושימו לב: ככל ש-λ גדל, צורת ההתפלגות מתקרבת לעקומת פעמון (נורמלית), ותמיד מתקיים μ = σ² = λ.
      </p>
