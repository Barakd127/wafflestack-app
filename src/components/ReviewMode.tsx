...
export default function ReviewMode({ building, onClose, onReQuiz }: Props) {
  ...
  return (
    <div
      style={{
        position: 'fixed', inset: 0, background: 'rgba(5, 20, 60, 0.75)',
    ...
    >
      <div
        style={{
          ...
          boxShadow: `0 0 60px ${color}22, 0 20px 60px rgba(0,0,0,0.15)`, position: 'relative',
        }}
      ...
      >
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <div style={{
            fontSize: 13, color: '#7F9BD9', marginTop: 2,
            direction: 'rtl',
          }}>
          ...
          <span style={{
            ...
            border: '1px solid rgba(31,122,110,0.3)',
            borderRadius: 20, padding: '2px 10px',
            fontSize: 11, color: '#1F7A6E',
          }}>
            ✓ Mastered
          </span>
        </div>
